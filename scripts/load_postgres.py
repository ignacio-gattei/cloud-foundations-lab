...
def load_csv(table, path, transform=None):
    with open(path) as f:
...
run_sql(SQL_DIR / "001_schema.sql")

# Orden de carga respeta FK
print("Cargando datos...")

n = load_csv("category_translations", DATA / "category_translations.csv",
...
n = load_csv("customers", DATA / "customers.csv",
...
n = load_csv("sellers", DATA / "sellers.csv",
...
n = load_csv("products", DATA / "products.csv",
...
n = load_csv("orders", DATA / "orders.csv",
...
n = load_csv("order_items", DATA / "order_items.csv",
             lambda r: {"order_id":           r["order_id"],
...
n = load_csv("order_payments", DATA / "order_payments.csv",
             lambda r: {"order_id":             r["order_id"],
...
n = load_csv("order_reviews", DATA / "order_reviews.csv",
